...
<head>
	...
	<title>The Lighters - Undergarment - Leather Gunmetal Buckle Belt</title>
	...
	<div class="table-responsive">
		...
		<td valign="top" style="width: 100px">
			<ul style="list-style-type:none;">
				<li><a href="belt2.php" target="boxes"><img src="../belts/belt2.png" width="50px" height="50px"/></a></li>
			</ul>
		</td>
	
	
		<td valign="top" style="width: 350px"><iframe name="boxes" width="330px" height="375px" src="belt2.php" 
		...
		<td valign="top">
			<article>
				<h1><span style="color: red"></span>Leather Gunmetal Buckle Belt</h1>
				<p>RM59.00</p>
				<p>Colour: <br/><a href="belt2.php" target="boxes">
				<img src="../belts/belt2.png" alt="Leather Gunmetal Buckle Belt" title="Leather Gunmetal Buckle Belt" width="40" height="40"/></a>
				</p>
				
				<p>Size available: <br/>S M L XL</p>
				<p>Description: <br/>This belt will instantly change the tone of your look. 100% leather.</p>
			</article>
