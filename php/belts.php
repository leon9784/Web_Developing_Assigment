...
<?php 
		...
		$sql = "SELECT * FROM `products` WHERE product_category = 'belt'";
...
<title>The Lighters - Accessories - Belts</title>
	...
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "../belts/" + image;
...
?>
	...
	<div class="container" style="margin-bottom:20px"><h2><strong>Belts</strong></h2></div>
...
<?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
  ...
  <div class="product-card">
	...
	<a><img id="product-image" class="identifyingClass" src="../belts/<?php echo $row['product_img']; ?>"
