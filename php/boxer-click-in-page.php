...
<head>
	...
	<title>The Lighters - Undergarment - Boxer Brief</title>
	...
	<div class="table-responsive">
		...
		<td valign="top" style="width: 100px">
			<ul style="list-style-type:none;">
				<li><a href="redboxer.php" target="boxes"><img src="../underwear/red-boxer-brief.jpg" width="50px" height="50px"/></a></li>
			</ul>
		</td>
	
	
		<td valign="top" style="width: 350px"><iframe name="boxes" width="330px" height="375px" src="redboxer.php" 
		...
		<td valign="top">
			<article>
				<h1><span style="color: red"></span>2 Pack Boxer Brief</h1>
				<p>RM25.00</p>
				<p>Colour: <br/><a href="redboxer.php" target="boxes"><img src="../underwear/red-boxer-brief.jpg" alt="Red Boxer" title="Red Boxer Brief" width="40" height="40"/></a></p>
