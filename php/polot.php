...
<?php 
		...
		$sql = "SELECT * FROM `products` WHERE product_category = 'polot'";
...
<title>The Lighters - Clothing - Polo-T</title>
	...
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "../polotshirt/" + image;
...
?>
	...
	<div class="container" style="margin-bottom:20px"><h2><strong>Polo-T</strong></h2></div>
...
<?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
  ...
  <div class="product-card">
	...
	<a><img id="product-image" class="identifyingClass" src="../polotshirt/<?php echo $row['product_img']; ?>"
