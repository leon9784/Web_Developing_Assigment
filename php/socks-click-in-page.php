...
<head>
	...
	<title>The Lighters - Undergarment - Cotton Socks</title>
	...
	<div class="table-responsive">
		...
		<td valign="top" style="width: 100px">
			<ul style="list-style-type:none;">
				<li><a href="blacksocks.php" target="boxes"><img src="../socks/socks-black.png" width="50px" height="50px"/></a></li>
				<li><a href="whitesocks.php" target="boxes"><img src="../socks/socks-white.png" width="50px" height="50px"/></a></li>
			</ul>
		</td>
	
	
		<td valign="top" style="width: 350px"><iframe name="boxes" width="330px" height="375px" src="blacksocks.php" 
		...
		<td valign="top">
			<article>
				<h1><span style="color: red"></span>Cotton Socks</h1>
				<p>RM59.00</p>
				<p>Colour: <br/><a href="blacksocks.php" target="boxes">
				<img src="../socks/black-colour.png" alt="Black Color" title="Black cotton socks" width="40" height="40"/></a>
				<a href="whitesocks.php" target="boxes"><img src="../socks/white-colour.png" alt="White Color" title="White cotton socks" width="40" height="40"/></a>
				</p>
				
				<p>Size available: <br/>S M L XL</p>
								<p>Description: <br/>Our sport socks promises odour-free feet. 78% cotton, 21% polyamide and 1% elastane.</p>
			</article>
