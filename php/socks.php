...
<?php 
		...
		$sql = "SELECT * FROM `products` WHERE product_category = 'socks'";
...
<head>
	...
	<title>The Lighters - Undergarment - Socks</title>
	...
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "../socks/" + image;
...
<div class="container" style="margin-bottom:20px"><h2><strong>Socks</strong></h2></div>
...
<?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
  ...
  <div class="product-card">
	...
	//$row['id'];
	?>
	<a><img id="product-image" class="identifyingClass" src="../socks/<?php echo $row['product_img']; ?>"
