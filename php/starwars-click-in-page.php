...
<head>
	...
	<title>The Lighters - Clothing - Star Wars T-Shirt</title>
	...
	<div class="table-responsive">
		...
		<td valign="top" style="width: 100px">
			<ul style="list-style-type:none;">
				<li><a href="starwars.php" target="boxes"><img src="../tshirt/starwars.jpg" width="50px" height="50px"/></a></li>
			</ul>
		</td>
	
	
		<td valign="top" style="width: 350px"><iframe name="boxes" width="330px" height="375px" src="starwars.php" 
		...
		<td valign="top">
			<article>
				<h1><span style="color: red"></span>Black Star Wars T-Shirt</h1>
				<p>RM59.00</p>
				<p>Colour: <br/><a href="starwars.php" target="boxes">
				<img src="../tshirt/starwars.jpg" alt="Black" title="Black" width="40" height="40"/></a>
				</p>
				
				<p>Size available: <br/>S M L XL</p>
				<p>Description: <br/>This shirt will instantly change the tone of your look on the street.</p>
			</article>
