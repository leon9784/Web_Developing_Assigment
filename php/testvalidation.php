...
<head>
<title>Sign Up for The Lighters</title>
...
<body>
    ...
    <div class="signup-form-container">
         ...
         <!-- form start -->
         <form method="post" role="form" id="register-form" autocomplete="off" action="processsignup.php">
         ...
         <!--
            ...
            <div class="form-footer">
                 ...
                 <span class="glyphicon glyphicon-log-in"></span> Already a member? Login
                 </button>
				 </a>
