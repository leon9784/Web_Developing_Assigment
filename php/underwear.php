...
<?php 
		...
		$sql = "SELECT * FROM `products` WHERE product_category = 'underwear'";
...
<head>
	...
	<title>The Lighters - Undergarment - Underwear</title>
	...
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "../underwear/" + image;
...
<div class="container" style="margin-bottom:20px"><h2><strong>Underwear</strong></h2></div>
...
<?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
  ...
  <div class="product-card">
	...
	<a><img id="product-image" class="identifyingClass" src="../underwear/<?php echo $row['product_img']; ?>"
