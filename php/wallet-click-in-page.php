...
<head>
	...
	<title>The Lighters - Accessories - Black Wallet</title>
	...
	<div class="table-responsive">
		...
		<td valign="top" style="width: 100px">
			<ul style="list-style-type:none;">
				<li><a href="blackwallet.php" target="boxes"><img src="../wallet/wallet.png" width="50px" height="50px"/></a></li>
			</ul>
		</td>
	
	
		<td valign="top" style="width: 350px"><iframe name="boxes" width="330px" height="375px" src="blackwallet.php" 
		...
		<td valign="top">
			<article>
				<h1><span style="color: red"></span>[NEW] Black Wallet</h1>
				<p>RM59.00</p>
				<p>Colour: <br/><a href="blackwallet.php" target="boxes">
				<img src="../wallet/wallet.png" alt="Black Color" title="Black Wallet" width="40" height="40"/></a>
				</p>
				
				<p>Size available: <br/>S M L XL</p>
				<p>Description: <br/>Genuine Leather. Fashion and Stylish Wallet.</p>
			</article>
