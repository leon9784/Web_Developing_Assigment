...
<?php 
		...
		$sql = "SELECT * FROM `products` WHERE product_category = 'wallet'";
...
<head>
	...
	<title>The Lighters - Accessories - Wallet</title>
	...
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "../wallet/" + image;
...
<div class="container" style="margin-bottom:20px"><h2><strong>Wallet</strong></h2></div>
...
<?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
  ...
  <div class="product-card">
	...
	<a><img id="product-image" class="identifyingClass" src="../wallet/<?php echo $row['product_img']; ?>"
